...
loginService.factory('loginService',function($resource,$rootScope){
    return $resource('http://'+$rootScope.hostname+'/MS4SF/public/index.php?api/authenticate/:id', { id: '@_id'}, {
        update: {
